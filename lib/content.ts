  ...
  cards: [
    {
      ...
      value: "300万",
      title: "强大的物流能力",
      desc: "年均发运量近300万台，自有轿运车超2000辆、可控船只10艘，提供公铁水多式联运方案。",
    },
    {
      icon: "globe",
      value: "全链路",
      title: "国际事业增值",
      desc: "汽车商贸与物流一体化服务，覆盖境外代理、器具租赁及贸易金融等多元需求。",
    },
    {
      icon: "car",
      value: "70家",
      title: "汽车经销网络",
      desc: "经营奔驰、奥迪、大众、丰田、沃尔沃等14个主流品牌，车源丰富、供给稳定。",
    },
  ],
}
  ...
  models: [
    {
      ...
      label: "交易模式",
      summary: "具备出口授权（合作品牌：现代），并可根据订单申请出口许可（合作品牌：奔腾、岚图、吉利），厂商资源直连，交付效率与成本控制均达到最优水平。",
    ...
    },
    {
      ...
      tags: ["资产价值提升", "强大资源整合"],
      label: "交易模式",
      summary: "整合订单、改装、许可、物流全链条资源，依次完成订单与改装、许可申请、物流与报关、口岸交付，实现资产价值提升与出口周期最短化。",
    ...
    },
    {
      ...
      tags: ["已转让 · 快许可", "新车标准"],
      label: "交易模式",
      summary: "车辆已完成转移待出口，合同签订后2—3日可提供出口许可。合作车型：卡罗拉1.2T，资源地点：天津/霍尔果斯/俄罗斯。",
      items: [
        "均已经完成转移待出口",
        "完成合同签订后2-3日可提供出口许可",
        "合作车型：卡罗拉1.2T",
...
export const achievements = {
  ...
  highlights: [
    { value: "300", unit: "户", label: "稳定海外商户", detail: "超300户" },
    { value: "100", unit: "户", label: "26年下单商户", detail: "超100户" },
    { value: "10", unit: "家", label: "稳定车源", detail: "超10家主机厂直接合作" },
    { value: "4", unit: "大区域", label: "出口国家", detail: "中国、俄罗斯、中东、非洲" },
  ],
  cards: [
    {
      title: "精准的市场洞察力",
